          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-4 lg:px-6 py-4 text-left text-sm lg:text-xl font-semibold text-gray-900">Rank</th>
                  <th className="px-4 lg:px-6 py-4 text-left text-sm lg:text-xl font-semibold text-gray-900">Name</th>
                  <th className="px-4 lg:px-6 py-4 text-left text-sm lg:text-xl font-semibold text-gray-900">Points</th>
                  <th className="px-4 lg:px-6 py-4 text-left text-sm lg:text-xl font-semibold text-gray-900 hidden md:table-cell">CO₂ Saved</th>
                  <th className="px-4 lg:px-6 py-4 text-left text-sm lg:text-xl font-semibold text-gray-900 hidden lg:table-cell">Waste Recycled</th>
                </tr>
              </thead>
...
function LeaderboardRow({ entry }) {
  const getRankDisplay = (rank) => {
    return <span className="text-gray-600 text-lg lg:text-2xl font-semibold">#{rank}</span>;
  };
